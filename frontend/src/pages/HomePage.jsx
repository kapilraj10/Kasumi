...
import { MapPinIcon, UserIcon, CheckCircleIcon, UserPlusIcon } from 'lucide-react';
import FriendCard from "../components/FriendCard";
import NoFriendsFound from '../components/NoFriendsFound';
import { capitalize, getLanguageFlagUrl } from '../lib/utils';
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    setOutgoingRequestsIds(Array.from(outgoingIds));
  }, [outgoingFriendReqs]);
